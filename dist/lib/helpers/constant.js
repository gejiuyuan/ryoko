export const _globalThis = globalThis !== void 0
    ? globalThis
    : self !== void 0
        ? self
        : window !== void 0
...
export const fetchBodyInitTypes = ['Blob', 'FormData', 'URLSearchParams', 'ReadableStream', 'String', 'Null'].concat(BufferSourceTypes);
